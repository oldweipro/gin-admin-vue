  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="认证真实姓名">
         <el-input v-model="searchInfo.certificationRealName" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="认证结果">
         <el-input v-model="searchInfo.certificationResult" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="认证结果" prop="certificationResult" />
        <el-table-column align="left" label="状态码" prop="certificationCode" width="120" />
        <el-table-column align="left" label="结果信息" prop="certificationMsg" width="120" />
        <el-table-column align="left" label="操作" width="120">
            <template #default="scope">
            <el-button type="disable" link icon="edit" size="small" class="table-button" @click="updateCertificationRecordFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="120px">
        <el-form-item label="真实姓名:"  prop="certificationRealName" >
          <el-input v-model="formData.certificationRealName" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="身份证号:"  prop="certificationIdCard" >
          <el-input v-model="formData.certificationIdCard" :clearable="true"  placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import {
  ...
  deleteCertificationRecordByIds,
...
const getTableData = async() => {
  const table = await getCertificationRecordList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const deleteRow = (row) => {
    ElMessageBox.confirm('确定要删除吗?', '提示', {
        ...
        type: 'warning'
            ...
            deleteCertificationRecordFunc(row)
        })
    }
